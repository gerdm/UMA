...
Defining the payoffs at $t=n$ allow us to solve this tree backwards until $t=0$, it also allow us to find a collection of $(\phi_i, \psi_i)$ variables in order to create the hedgning portfolio and guarantee the promised payoff.
